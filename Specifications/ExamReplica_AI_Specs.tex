...
\section{Problem}
Students preparing for exams face two major issues:

\begin{itemize}
\item Generic AI-generated practice is rarely course-specific: it does not reliably reflect an instructor's exam structure, pacing, grading style, or concept emphasis inferred from real course materials.
...
\item Grades submissions with diagnostically useful, structured feedback beyond correct/incorrect, surfacing what was correct, what method was misapplied, and which conceptual weakness is indicated
...
\item Students who can provide course evidence (slides, homework, prior exams) and want course-specific, professor-aligned exam simulation
...
Builds a structured Professor Profile capturing instructor tendencies and course patterns (topic emphasis, question-type distribution, structure, and approximate difficulty), using an evidence-weighted approach that prioritizes stronger signals (e.g., past exams) when available.
