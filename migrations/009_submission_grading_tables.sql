...
-- Creates submissions, submission_answers, grading_results, error_classifications.
-- Column names match backend/models/grading.py exactly.
...
-- ============================================================
-- updated_at triggers (reuse the set_updated_at() function
...
-- ------------------------------------------------------------------
-- error_classifications: scoped via grading_result → submission_answer
