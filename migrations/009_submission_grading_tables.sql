...
create index idx_submission_answers_question_id on public.submission_answers(generated_question_id);
...
-- grading_results: scoped via submission_answer -> submission -> workspace owner
...
-- error_classifications: scoped via grading_result -> submission_answer -> submission -> workspace owner
